...
final_video_name = input("Enter the final video name with extension: ")
audio_path = input("Enter the audio_path: ")
...
intro_duration = 5
intro_text = TextClip("Welcome to my garden!", fontsize=70, color='white', size=video_clip.size)
